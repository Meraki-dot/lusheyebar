        ...
        <div className="policy-container">
          <div className="policy-details-container">
            ...
            <ul>
              ...
              <li>
                Stop using lash serum 3 days prior to service (Latisse,
                Revitalash, Lash Food, etc.)
              </li>
              <li>Stop using mascara 3 days before appointment.</li>
              <li>
                Please eat and use the bathroom prior to service, as the process
                can take up to 3 hours.
              </li>
              <li>
                Shower before appointment is advised, as you will need to avoid
                water in the eye area for at least 24 hours to allow the
                adhesive to dry.
              </li>
          ...
          <div className="policy-details-container">
            ...
            <ul>
              ...
              <li>
                To extend the life of your lashes, please schedule a touch up
                every 2-3 weeks.
              </li>
            </ul>
          </div>
