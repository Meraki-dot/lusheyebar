  ...
  return (
    <div className="container" id="mobile_service_options">
      ...
      <div id="service_items">
        ...
        <p className="price_text price_group solo">
          <strong>Bikini Line</strong> Serviced performed 5 weeks prior · 30 min
          · $40+{" "}
        </p>
        <p className="price_text price_group solo">
        ...
        <p className="price_text price_group solo_last">
          <strong>Full Bikini</strong> Serviced performed 5 weeks prior · 30 min
          · $50+
        </p>
        <Link to="/schedule">{button_title}</Link>
        ...
        <p className="price_text price_group solo">
          <strong>Back</strong> <em>Top to above panty line</em> · 30 mins · $65
        </p>
        <p className="price_text price_group solo">
