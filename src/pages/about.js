...
const About = () => (
  <Layout>
    ...
    <div className="container" id="about">
      ...
      <p className='subtext'>simple · real · kind</p>
      ...
      <p className='read-text'>
        ...
        something, reimagine it and recreate it. Additionally, she graduated
        with a degree in Business Management and worked in banking as a
        Relationship Manager. Along with founding Lush Eye Bar, she is a
        licensed esthetician. She is certified by Daria Chupry, Eyes by Sally
        and Thuy Tien as a permanent cosmetic artist. She is also an eyelash ace
        certified by Lash Box LA, Co0kies Beauty Bar and Olivia and Lash.
      </p>
      <p className='read-text'>
